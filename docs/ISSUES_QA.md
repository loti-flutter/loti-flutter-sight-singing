...
`purchase` `licensing` · 打开于 2026-05-18 · [@hz-yinyue-dev](https://github.com/hz-yinyue-dev)
...
付款后交付周期是否仍为 1–3 个工作日？我们需要在 9 月开学前上线试点。

---

**Loti 官方回复** · 2026-05-19
...
**4. 交付周期**  
付款凭证在本 Issue 确认后 **1–3 个工作日** 安排对应版本交付；年度授权版售后同样通过 **GitHub Issue 留言** 处理，请在帖内 @loti-edu 或等待官方回复。

如需合同与发票，请在本 Issue 补充说明，我们会通过 **Issue 私信式回复**（或评论指引）跟进，无需另行拨打客服电话。

---

## Issue #18 · 集成接入

`integration` `flutter` · 打开于 2026-05-20 · [@chen_flutter](https://github.com/chen_flutter)
...
`classroom` `ipad` · 打开于 2026-05-21 · [@music_teacher_li](https://github.com/music_teacher_li)
...
`midi` `music-theory` · 打开于 2026-05-22 · [@score_lib_admin](https://github.com/score_lib_admin)
...
`scoring` `exam` · 打开于 2026-05-23 · [@art_exam_lab](https://github.com/art_exam_lab)
...
`pitch-detection` `audio` · 打开于 2026-05-24 · [@audio_eng_wang](https://github.com/audio_eng_wang)
...
`web` `platform` · 打开于 2026-05-24 · [@edu_saas_team](https://github.com/edu_saas_team)
...
`purchase` `billing` · 打开于 2026-05-24 · [@indie_dev_zhao](https://github.com/indie_dev_zhao)
...
**1. 抵扣政策**  
测试版费用 **是否抵扣升级款** 需个案确认，请在 [购买咨询 Issue 模板](https://github.com/loti-flutter/loti-flutter-sight-singing-plugin/issues/new?template=purchase.yml) 中注明已购测试版与付款时间，商务会回复可抵扣金额。
...
`support` `after-sales` `sdk` · 打开于 2026-05-25 · [@studio_flutter_2026](https://github.com/studio_flutter_2026)
...
你好，我们 5 月 22 日付款购买了 **年度授权版**，SDK 和 License Key 已收到，Flutter 3.19 集成基本完成。
...
按 README 说明提交了 [购买咨询 Issue](https://github.com/loti-flutter/loti-flutter-sight-singing-plugin/issues)，又在 **本帖跟评** 补充了日志，但两天暂无新回复。项目 **下周三演示**，能否帮忙加急看一下？失败样本和录屏我可以继续发在本帖。

订单备注：`Loti视唱插件-年度授权-某某音乐-138****6620`（手机号此处省略）

---

**Loti 官方回复** · [@loti-support-chen](https://github.com/loti-support-chen) · 2026-05-25 · *（该评论已被编辑）*

抱歉让您久等，年度授权客户的售后我们这边优先跟进。

您描述的两项看起来像是 **Format 1 多轨 Meta 兼容** 和 **iOS AudioSession 被系统打断**，需要看具体样本才能定。

演示前如果比较急，可以直接加我们 **售后微信 `lk052419`**，把失败 MIDI 和 iOS 录屏发过去，值班同事 tonight 可以帮你看一下。备注写机构名就行。

---

**Loti 官方回复** · [@loti-edu](https://github.com/loti-edu) · 2026-05-25
...
| 工单 | 现象 | 初步判断 |
|------|------|----------|
| LOTI-20260525-01 | 部分 MIDI `midi_parse_failed` | SMF Format 1 非标准 Tempo / 轨 Meta 事件 |
| LOTI-20260525-02 | iOS 偶发无音高曲线 | AudioSession 切换、`measurement` 模式被打断 |

请在本 Issue 补充（**全部在本帖留言即可，无需邮件或电话**）：

- [ ] 失败 MIDI **任选 1 个** 脱敏样本（附件或网盘链接）  
- [ ] iOS 版本、机型、是否蓝牙 / 有线耳机  
- [ ] `flutter doctor -v` 与插件版本号  

年度授权客户我们会在 **1 个工作日内** 于 **本 Issue 回复**；演示前可加 `[P1]` 标记。
...
**追问** · [@studio_flutter_2026](https://github.com/studio_flutter_2026) · 2026-05-25

收到。上一条评论里的微信我看到了，已经加 `lk052419` 并把两个样本发过去了，值班同事回复说是 Tempo 事件问题，今晚先 workaround。

另外想确认：**以后年度售后是不是都在 GitHub Issue 留言处理？** 演示前还怕联系不上。

---

**Loti 官方回复** · [@loti-edu](https://github.com/loti-edu) · 2026-05-26
